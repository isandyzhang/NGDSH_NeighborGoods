...
namespace NeighborGoods.Api.Shared.Persistence.LegacyScaffold;

public partial class RecoveredDbContext : DbContext
{
    public RecoveredDbContext(DbContextOptions<RecoveredDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<LineBindingPending> LineBindingPendings { get; set; }

    public virtual DbSet<Listing> Listings { get; set; }

    public virtual DbSet<ListingImage> ListingImages { get; set; }

    public virtual DbSet<ListingTopSubmission> ListingTopSubmissions { get; set; }
