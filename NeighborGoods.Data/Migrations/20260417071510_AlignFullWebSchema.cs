...
{
    /// <inheritdoc />
    public partial class AlignFullWebSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineMessagingApiAuthorizedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LineMessagingApiUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LineNotificationPreference = table.Column<int>(type: "int", nullable: false),
                    LineNotificationLastSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EmailNotificationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    EmailNotificationLastSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TopPinCredits = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Participant1LastReadAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Participant2LastReadAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
